            ...
            <>
                ...
                <div>
                    <ContainerSubParagraph>
                        <div style={{width: '95%'}}>
                            <Title2>สถานการณ์จำลอง</Title2><br /><br />
                        ...
                        <div style={{width: '95%'}}>
                            <Title2>ระบบ SCG Active AIRquality คืออะไร ทำงานอย่างไร</Title2><br /><br />
                            <Title3 style={{lineHeight: 2}}>
        ...
        <>
            ...
            <div>
                <ContainerSubParagraph>
                    ...
                    <div style={{width: '95%'}}>
                        <Title2>ระบบ SCG Active AIRflow คืออะไร ทำงานอย่างไร</Title2><br /><br />
                        <Title3 style={{lineHeight: 2}}>
